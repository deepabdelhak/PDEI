         ...
         <div class="navigation">
            <nav class="navbar navbar-expand-lg navbar-bg">
               ...
               <div class="brand-logo">
                  <a class="navbar-brand" href="dec.php" id="menu-action">
                     <?php 
                  ...
                  <div id="mobile-authotication">
                     <ul>
                       ...
                       if(file_exists($profilePhoto)){ ?>
                        ...
                        <li><span><strong>Bienvenue ! </strong><?php echo $userName = Session::get('userName'); ?></span>
                        </li>
                  ...
                  <ul class="navbar-nav user-info d-desktop ml-auto mt-2 mt-lg-0">
                     <li class="nav-item dropdown show">
                       ...
                       if(file_exists($profilePhoto)){ ?>
                           ...
                           <strong> Bienvenue ! </strong><?php echo $userName = Session::get('userName'); ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                           ...
                           <a class="dropdown-item" href="?action=logout&&sunset=id"><i
                                 class="material-icons">exit_to_app</i>Déconnexion</a>
                        </div>
                     </li>
                  </ul>
