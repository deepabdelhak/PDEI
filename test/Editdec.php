...
<body>
    <h1>MODIFIER FICHE D'INVESTIGATION ET DE DECLARATION DES EVENEMENTS INDESIRABLES</h1>
        ...
        <div class="section">
            ...
            <div class="grid">
                <fieldset>
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Orientation usager inadaptée"> Orientation usager inadaptée</label>
                    <label><input type="checkbox" name="event_types[]" value="Médecin indisponible en urgence"> Médecin indisponible en urgence</label>
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Situation épidémique"> Situation épidémique</label>
                    <label><input type="checkbox" name="event_types[]" value="Malade contagieux à germe résistant non isolé"> Malade contagieux à germe résistant non isolé</label>
                    <label><input type="checkbox" name="event_types[]" value="Malade contagieux à germe résistant non signalé"> Malade
                        contagieux à germe résistant non signalé</label>


                    <h5>MEDICAMENTS</h5>
                    <label><input type="checkbox" name="event_types[]" value="Prescription : absente, incomplète ou d'origine inconnue"> Prescription :
                        absente, incomplète ou d'origine inconnue</label>
                    <label><input type="checkbox" name="event_types[]" value="Prescription non compréhensible (lisibilité)">
                        Prescription non compréhensible (lisibilité)</label>
                    <label><input type="checkbox" name="event_types[]" value="Dispensation : erreur, manque"> Dispensation :
                        erreur, manque</label>
                    <label><input type="checkbox" name="event_types[]" value="Médicament périmé"> Médicament
                        périmé</label>
                    <label><input type="checkbox" name="event_types[]" value="Administration : erreur, non-respect"> Administration :
                        erreur, non-respect</label>
                    <label><input type="checkbox" name="event_types[]" value="Problème de communication lors de chargement de prestataires"> Problème de
                        communication lors de chargement de prestataires</label>
                    <label><input type="checkbox" name="event_types[]" value="Absence de renseignements cliniques"> Absence de
                        renseignements cliniques</label>
                    <label><input type="checkbox" name="event_types[]" value="Problème de délai de prise en charge"> Problème de délai de
                ...
                <fieldset>
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Matériel non adapté ou dangereux"> Matériel non adapté
                        ou dangereux</label>
                    <label><input type="checkbox" name="event_types[]" value="Défaut de prise en charge d'un dysfonctionnement"> Défaut de prise
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Problèmes de délai de retour des résultats"> Problèmes de
                        délai de retour des résultats</label>
                    <label><input type="checkbox" name="event_types[]" value="Groupe sanguin : problème(incompatibilité)"> Groupe sanguin :
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Demande non conforme / incomplète"> Demande non
                        conforme / incomplète</label>
                    <label><input type="checkbox" name="event_types[]" value="Absence de renseignements cliniques"> Absence
                        de renseignements cliniques</label>
                    <label><input type="checkbox" name="event_types[]" value="Problème de PEC irradiation intempestive"> Problème de PEC
                        irradiation intempestive</label>
                    <label><input type="checkbox" name="event_types[]" value="Résultats éronés mauvaise qualité des clichés"> Résultats éronés
                ...
                <fieldset>
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Délai d'attente excessif pour l'usager"> Délai d'attente excessif
                        pour l'usager</label>
                    <label><input type="checkbox" name="event_types[]" value="Lit d'hospitalisation"> Lit
                        d'hospitalisation</label>
                    <label><input type="checkbox" name="event_types[]" value="agressionAgression / violence_violence"> Agression /
                        violence</label>
                    <label><input type="checkbox" name="event_types[]" value="Refus de soins opposé par l'usager"> Refus de soins opposé par
                        l'usager</label>
                    <label><input type="checkbox" name="event_types[]" value="Sortie contre avis médical"> Sortie contre avis
                        médical</label>
                    <label><input type="checkbox" name="event_types[]" value="Sortie sans avis médical (fugue)"> Sortie sans avis
                        médical (fugue)</label>

                    <h5>PRISE EN CHARGE HOTELIERE:</h5>
                    <label><input type="checkbox" name="event_types[]" value="Repas : quantité / qualité / souhait non respecté"> Repas : quantité /
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Blessures (brûlure, coupure, piqûre)"> Blessures (brûlure, coupure,
                        piqûre)</label>
                    <label><input type="checkbox" name="event_types[]" value="Suicide ou tentative /automutilation"> Suicide ou tentative
                        /automutilation</label>


                    <h5>VOL/DISPARITION/DEGRADATION</h5>
                    <label><input type="checkbox" name="event_types[]" value="Dégradation de matériel/vandalisme"> Dégradation de
                        matériel/vandalisme</label>
                    <label><input type="checkbox" name="event_types[]" value="Inondation, incendie"> Inondation,
                        incendie</label>
                    <label><input type="checkbox" name="event_types[]" value="Vol – Disparition – Perte (à préciser)"> Vol – Disparition –
                        Perte (à préciser)</label>

                    <h5>COMMUNICATIONS:</h5>
                    <label><input type="checkbox" name="event_types[]" value="Déficience bip, téléphone, alarme"> Déficience bip,
                        téléphone, alarme</label>
                    <label><input type="checkbox" name="event_types[]" value="Problème informatique"> Problème
                        informatique</label>
                    <label><input type="checkbox" name="event_types[]" value="Perte du dossier ou d'une pièce du dossier"> Perte du dossier ou d'une
                    ...
                    <label><input type="checkbox" name="event_types[]" value="Défaut tri/évacuation/traitement/Elimination"> Défaut
            ...
            <label for="other_signalements">AUTRES SIGNALEMENTS en rapport avec RH, batiment, financier, système
                informatique:</label>
            ...
            <div class="causes-container">
                ...
                <fieldset class="causes-fieldset">
                    ...
                    <div class="checkbox-container">
                        ...
                        <label class="checkbox-item"><input type="checkbox" name="cause[]" value="Perte de revenues"> Perte
                            de revenues</label>
                        <label class="checkbox-item"><input type="checkbox" name="cause[]"
