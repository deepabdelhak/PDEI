   ...
   if ($header_contents) {
      while ($result = $header_contents->fetch_assoc()) {
         ...
         <link rel="shortcut icon" href="<?php if (isset($result['favicon'])) {
            ...
            echo "assets/images/icons/favicon.png";
         } ?>" type="image/png">
      <?php }
   } ?>
...
<body>
   ...
   <div class="wrap">
      <!-- page BODY -->
      <!-- ========================================================= -->
      <div class="page-body animated slideInDown" style="padding-top: 35px;">
         <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
         <!--LOGO-->
            ...
            if ($header_contents) {
               while ($result = $header_contents->fetch_assoc()) {
                  ...
                  <div class="logo-container">
                     <img src="<?php if (isset($result['logo'])) {
                        echo $result['logo'];
                     } else {
                  ...
                  <h3 class="text-center"><?php if (isset($result['front_name'])) {
                     ...
                     if (isset($front_name)) {
                        $words = str_word_count($front_name, format: 1);
                        echo "<span class='benzi'>$front_name</span>";
                     }
                     ...
                     <div class="form-group">
                        <div class="checkbox-custom checkbox-primary">
                           <input type="checkbox" name="remember" id="remember" <?php if (isset($_COOKIE["email"])) { ?>
                                 checked <?php } ?> />
                           <label class="check" for="remember">Souviens-toi de moi</label>
                        </div>
                     </div>
                     <div class="form-group">
                        <button type="submit" name="login" id="login"
                           class="btn text-white theme-primary-btn btn-primary btn-block">Se connecter</button>
                     </div>
